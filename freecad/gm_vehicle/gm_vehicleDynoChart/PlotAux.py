...
class Plot(object):
    ...
    def update(self, gm_vehicle, points):   #sub for ship
        self.points = points[:]
        self.fillSpreadSheet(gm_vehicle)  # for ship
    ...
    def plotVolume(self):
        ...
        try:
            ...
            try:
                ...
                msg = "Plot module is disabled, so I cannot perform the plot"
    ...
    def spreadSheet(self, gm_vehicle):    # sub for ship
        ...
        self.sheet = FreeCAD.activeDocument().addObject('Spreadsheet::Sheet',
                                                        'Dyno Chart Emprical Data')   #sub Hydrostatics
        self.fillSpreadSheet(gm_vehicle)
