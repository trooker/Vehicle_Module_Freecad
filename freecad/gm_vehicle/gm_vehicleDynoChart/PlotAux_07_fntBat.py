...
class Plot(object):
    def __init__(self, gm_vehicle, points):    #sub for ship
        ...
        self.points = points[:]
        self.plt1 = self.plt2 = self.plt3 = self.plt4 = None
        ...
        self.plotFnt_NomVI() 
        self.plotFnt_PackVI() 
        self.plotFnt_Volt()       # Pack Voltage and Voltage Sag dependnet on Cell Current
        self.plotFnt_MoPwr()    #  Motor Power and Module Current dependnet on Cell Current
    ...
    def plotFnt_NomVI(self):
        ...
        pltTitle = "FntBat:: Cell Current To Pack Voltage"
        try:
...
#FWD*****************
    def plotFnt_PackVI(self):
        """ Graph the Accel - Traction of Vehicle
        @return True if error happens.
        """
        msg = "Dev: Arrived lotFnt_PackVI()"
        App.Console.PrintMessage(msg + '...\n')
        
        pltTitle = "FntBat:: Cell Current To Pack Current & Power"
        try:
            from FreeCAD.Plot import Plot
        except ImportError:
            try:
...
#        for i in range(len(self.points)):
    ...
    def plotFnt_Volt(self):
        """
        Graph the plotFnt_Volt
        @return True if error happens.
        """
        msg = "Dev: Arrived ()"
        App.Console.PrintMessage(msg + '...\n')
        
        pltTitle = "FntBat::Cell Current to Voltage Response"
        try:
            from FreeCAD.Plot import Plot
        except ImportError:
            try:
    ...
    def plotFnt_MoPwr(self):
        ...
        pltTitle = "FntBat::Cell Current to Motor Pwr & Module Current"
        try:
            from FreeCAD.Plot import Plot
        except ImportError:
            try:
    ...
    def spreadSheet(self, gm_vehicle):    # sub for ship
        ...
        self.sheet = App.activeDocument().getObjectsByLabel('07_FnBattery-Capa')[0]
