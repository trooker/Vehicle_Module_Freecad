...
#*                                                                         *
#*   Used general Ship flow for PlotAux_01_fntMotorDyno.py substituting gm_vehicle content     *
#*                                                                         *
...
def autolim(ax):
    ...
    try:
        ...
        pass
"""
# DEV 240213  Aux_01_fntMotorDyno     
class Plot(object):
    ...
    def plotFntMotorDyno(self):
        """ Graph the Dyno CHart for the Front Motor
        @return True if error happens.
        """
        msg = "Dev: Arrived plotFrntMotorDyno()"
        App.Console.PrintMessage(msg + '...\n')
        
        pltTitle = "Front Motor Dyno Chart"
        try:
...
#        for i in range(len(self.points)):
    ...
    def spreadSheet(self, gm_vehicle):    # sub for ship
        ...
        self.sheet = App.activeDocument().getObjectsByLabel('01_Front_dynoChart')[0]
