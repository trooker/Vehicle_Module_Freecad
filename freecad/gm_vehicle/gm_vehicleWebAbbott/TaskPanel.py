...
class TaskPanel:
    def __init__(self):
        self.name = "Render Abbottanp.com webpage"
        self.ui = ":/ui/TaskPanel_gm_vehicleAbbott.ui"
        self.form = Gui.PySideUic.loadUi(self.ui)
        App.Console.PrintMessage("Launching Abbottanp.com web page.  Close Combo/Tree Panel and Maximize FC Window.\n")
        xmsg = 'As needed switch to the Web workbench to access browser navigation icons.\n'    
        App.Console.PrintMessage(xmsg)   
        WebGui.openBrowser('https://www.abbottanp.com')
    ...
    def setupUi(self):
        ...
        self.form.gm_vehicle = self.widget(QtGui.QGroupBox, "GM_VehicleAbbottBox")
        self.form.mainLogo = self.widget(QtGui.QLabel, "MainLogo")
        self.form.mainLogo.setPixmap(QtGui.QPixmap(":/icons/WebAbbott.svg"))
